...
-- Volcando datos para la tabla sisintupt.bloqueshorarios: ~2 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `horarios` (
  ...
  KEY `FK_horario_laboratorio` (`laboratorio`) USING BTREE,
  ...
  CONSTRAINT `FK_horario_laboratorio` FOREIGN KEY (`laboratorio`) REFERENCES `laboratorio` (`IdLaboratorio`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `horarios` (`IdHorario`, `laboratorio`, `bloque`, `diaSemana`, `ocupado`) VALUES
	(258, 1, 10, 'Lunes', 0),
	(259, 1, 10, 'Martes', 0),
...
-- Volcando estructura para tabla sisintupt.laboratorio
CREATE TABLE IF NOT EXISTS `laboratorio` (
  ...
  KEY `FK_laboratorio_facultad` (`Facultad`),
  KEY `FK_laboratorio_escuela` (`Escuela`),
  CONSTRAINT `FK_laboratorio_escuela` FOREIGN KEY (`Escuela`) REFERENCES `escuela` (`IdEscuela`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_laboratorio_facultad` FOREIGN KEY (`Facultad`) REFERENCES `facultad` (`IdFacultad`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla sisintupt.laboratorio: ~7 rows (aproximadamente)
INSERT INTO `laboratorio` (`IdLaboratorio`, `Nombre`, `Capacidad`, `Estado`, `Facultad`, `Escuela`) VALUES
	(1, 'a', 15, 1, 1, 1),
	(2, 'LAB C', 15, 0, 1, 1),
	(3, 'LAB D', 15, 0, 1, 1),
	(4, 'LAB F', 15, 1, 1, 1),
...
CREATE TABLE IF NOT EXISTS `reserva` (
  ...
  KEY `FK_reserva_laboratorio` (`laboratorio`),
  KEY `FK_reserva_usuario` (`usuario`),
  KEY `FK_reserva_facultad` (`Facultad`),
  KEY `FK_reserva_escuela` (`Escuela`),
  CONSTRAINT `FK_reserva_escuela` FOREIGN KEY (`Escuela`) REFERENCES `escuela` (`IdEscuela`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_reserva_facultad` FOREIGN KEY (`Facultad`) REFERENCES `facultad` (`IdFacultad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_reserva_laboratorio` FOREIGN KEY (`laboratorio`) REFERENCES `laboratorio` (`IdLaboratorio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `reserva` (`IdReserva`, `usuario`, `laboratorio`, `fechaReserva`, `bloque`, `estado`, `fechaSolicitud`, `Facultad`, `Escuela`, `diaSemana`, `Descripcion`) VALUES
	(19, 5, 1, '2025-09-15', 10, 'Aprobada', '2025-09-15 22:44:01', 1, 1, 'Lunes', 'Curso:1-Tema:1'),
	(20, 5, 1, '2025-09-16', 10, 'Cancelado', '2025-09-16 00:33:02', 1, 1, 'Martes', 'Curso:Base de Datos-Tema:Jugar');
...
-- Volcando datos para la tabla sisintupt.rol: ~2 rows (aproximadamente)
...
INSERT INTO `usuario` (`IdUsuario`, `Nombre`, `Apellido`, `CodigoU`, `CorreoU`, `TipoDoc`, `NumDoc`, `Rol`, `Facultad`, `Escuela`, `Celular`, `Genero`, `Password`, `Estado`, `Sesion`) VALUES
	...
	(7, 'DAYAN', 'JAHUIRA', '2023076800', 'Dayan@hotmail.com', 'DNI', '12345678', 3, 1, 1, '123456789', b'1', 'oIvcW/9aUeOndiWld/1JjFEhYVW0p25zyUCyKYL6IP0=', 0, 0),
	(10, 'STEVIE', 'AGUILAR', '2023076808', 'stevie@upt.edu', 'DNI', '12345679', 3, 1, 1, '987654321', b'1', 'APRt0kF8p6Kv+q8Zw7EcG/4Ob7WXZE3pNsNzByTy6mg=', 1, 0),
...
BEGIN
    ...
    IF NEW.estado = 'Aprobado' THEN
        UPDATE horarios h
        SET h.ocupado = 1
        WHERE h.laboratorio = NEW.laboratorio
...
FOR EACH ROW
BEGIN
    -- Insertar horarios automáticamente para cada laboratorio y cada día de la semana
    INSERT INTO horarios (laboratorio, bloque, diaSemana, ocupado)
    SELECT l.IdLaboratorio, NEW.IdBloque, d.dia, 0
    FROM laboratorio l
    CROSS JOIN (
        SELECT 'Lunes' AS dia
